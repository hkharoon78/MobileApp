...
open class WSTagView: UIView {
    ...
    public init(tag: WSTag) {
     ...
     //   super.init(frame: CGRect(x: 12, y: 8, width: CGRect.zero, height: CGRect.zero))
    ...
    @objc func handleTapGestureRecognizer(_ sender: UITapGestureRecognizer) {
        ...
        if let onDidRequestSelectionLocal = self.onDidRequestSelection {
            onDidRequestSelectionLocal(self)
        }
    }
