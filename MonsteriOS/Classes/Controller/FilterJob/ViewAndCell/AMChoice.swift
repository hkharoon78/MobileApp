...
class AMChoice: UIView,UITableViewDelegate,UITableViewDataSource {
    ...
    func setUpUI(){
        tableView.register(UINib(nibName: String(describing: MIRadioTableViewCell.self), bundle: nil), forCellReuseIdentifier: String(describing: MIRadioTableViewCell.self))
        ...
        NSLayoutConstraint.activate([tableView.topAnchor.constraint(equalTo: self.topAnchor),tableView.bottomAnchor.constraint(equalTo: self.bottomAnchor),tableView.leadingAnchor.constraint(equalTo: self.leadingAnchor),tableView.trailingAnchor.constraint(equalTo: self.trailingAnchor)])
    ...
    override func layoutSubviews() {
        ...
        self.contentHeight=self.tableView.contentSize.height
    }
    ...
    final func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lblTitle.textColor = textColor ?? cell.lblTitle.textColor
        return cell
    }
