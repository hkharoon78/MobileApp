...
class MIDatePicker: NSObject {

    static private let sharedInstance = MIDatePicker()
    ...
    class func selectDate(title: String = "",
        ...
        if let currentController = UIWindow.currentController {
            ...
            UIView.animate(withDuration: pickerAnimationDuration, animations: {
                ...
                UIView.animate(withDuration: pickerAnimationDuration, animations: {
                  //  viewTransperant.backgroundColor = UIColor(red: (0/255.0), green: (0/255.0), blue: (0/255.0), alpha: 0.1)
                })
            })
